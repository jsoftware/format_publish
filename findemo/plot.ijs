...
dat=. |. 3 4$0 (I. d e. __)} d=.".fread PUBPATH,'data_2_1_1_pic1.txt'
pd dat
...
pd 'yticpos ',": 0.5 * i.11
pd 'xlabel Maaseutu Taajama City Yhteensä'
dat=. |. 3 4$0 (I. d e. __)} d=.".fread PUBPATH,'data_2_1_2_pic1.txt'
pd dat
...
NB. =========================================================
plot_2_1_1_pic2=: 3 : 0
dat=. ".fread PUBPATH,'data_2_1_1_pic2.txt'
...
NB. =========================================================
plot_2_1_2_pic2=: 3 : 0
dat=. ".fread PUBPATH,'data_2_1_2_pic2.txt'
key=. KEY_2_1_1 ,each ' ' ,each (":each dat) ,each <'%'
key=. ;'"',each key ,each <'" '
pd 'reset'
pd 'type pie'
...
NB. =========================================================
plot_2_1_2_pic3=: 3 : 0
dat=. ".fread PUBPATH,'data_2_1_2_pic3.txt'
...
NB. =========================================================
plot_2_1_4_pic2=: 3 : 0
dat=. ".fread PUBPATH,'data_2_1_4_pic2.txt'
key=. KEY_2_1_1 ,each ' ' ,each (":each dat) ,each <'%'
key=. ;'"',each key ,each <'" '
pd 'reset'
pd 'type pie'
...
pd 'yticpos ',": 0.5 * i.9
pd 'xlabel Maaseutu Taajama City Yhteensä'
dat=. |. 3 4$0 (I. d e. __)} d=.".fread PUBPATH,'data_2_2_1_pic1.txt'
pd dat
...
pd 'yticpos ',": 0.5 * i.11
pd 'xlabel Maaseutu Taajama City Yhteensä'
dat=. |. 3 4$0 (I. d e. __)} d=.".fread PUBPATH,'data_2_2_2_pic1.txt'
pd dat
...
dat=. 3 9$0 (I. d e. __)} d=.".fread PUBPATH,'data_3_1_1_pic1.txt'
pd dat
...
dat=.0 (I. d e. __)} d=.".fread PUBPATH,'data_4_3_pic1.txt'
pd dat
...
dat=. |:4 4$0 (I. d e. __)} d=.".fread PUBPATH,'data_6_1_1_pic1.txt'
pd dat
...
pd 'key Luonnonilmiöt "Tekniset syyt" "Ulkopuoliset syyt" "Suunnitellut keskeytykset"'
pd 'keypos rmo;keystyle bf'
dat=. |:4 2$0 (I. d e. __)} d=.".fread PUBPATH,'data_6_1_2_pic1.txt'
pd dat
...
NB. =========================================================
plot_6_2_1_pic1=: 3 : 0
dat=. <.0.5+100*(%+/d)*d=.".fread PUBPATH,'data_6_2_1_pic1.txt'
...
pd 'key Luonnonilmiöt "Tekniset syyt" "Ulkopuoliset syyt" "Suunnitellut keskeytykset"'
pd 'keypos rmo;keystyle bf'
dat=. |:4 8$0 (I. d e. __)} d=.".fread PUBPATH,'data_6_2_1_pic2.txt'
pd dat
...
NB. =========================================================
plot_6_2_2_pic1=: 3 : 0
dat=. <.0.5+100*(%+/d)*d=.".fread PUBPATH,'data_6_2_2_pic1.txt'
key=. KEY_6_2_1 ,each ' ' ,each (":each dat) ,each <'%'
key=. ;'"',each key ,each <'" '
pd 'reset'
pd 'type pie'
...
pd 'key Luonnonilmiöt "Tekniset syyt" "Ulkopuoliset syyt" "Suunnitellut keskeytykset"'
pd 'keypos rmo;keystyle bf'
dat=. |:4 8$0 (I. d e. __)} d=.".fread PUBPATH,'data_6_2_2_pic2.txt'
pd dat
...
NB. =========================================================
plot_7_1_pic1=: 3 : 0
dat=. |.0.01 * _3 [\ ".fread PUBPATH,'data_7_1_pic1.txt'
